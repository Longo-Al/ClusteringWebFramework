...
public class MainTest {
    ...
    public static void main(String[] args) {
        String ip = System.getProperty("ip", "0.0.0.0");
        System.out.println("Ip non inserito, uso quello di default " + ip);
        String argport = System.getProperty("port", "5000");
        System.out.println("Porta non inserita, uso quella di default: " + argport);
        ...
        try {
            ...
            System.out.println("Sembra che qualcosa non vada col server.");
        }
    }
}
